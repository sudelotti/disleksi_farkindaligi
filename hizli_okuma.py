...
class HizliOkumaTesti(TemelTest):
    ...
    def testi_bitir_ve_kaydet(self):
        ...
        if self.yonetici.aktif_ogrenci_no:
            ...
            # Eğer okuma süresi 0'dan büyükse testler çözülmüş demektir.
            # anket_sonucu_isles verileri rapora yazdırmadan önce testlerin çözülüp çözülmediğini bilsin diye
            self.yonetici.veri_yoneticisi.puan_guncelle(self.yonetici.aktif_ogrenci_no, "okuma_suresi", self.okuma_suresi)
